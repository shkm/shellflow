...
function App() {
  const { projects, addProject, removeProject, createWorktree, deleteWorktree, renameWorktree, reorderProjectsOptimistic, reorderWorktreesOptimistic, refresh: refreshProjects } = useWorktrees();
